...
describe('database layer', () => {
  ...
  test('all required tables exist', () => {
    ...
    expect(tableNames).toContain('nvz_rules');
    expect(tableNames).toContain('storage_requirements');
    expect(tableNames).toContain('buffer_strip_rules');
    expect(tableNames).toContain('abstraction_rules');
    expect(tableNames).toContain('pollution_prevention');
    expect(tableNames).toContain('eia_screening');
